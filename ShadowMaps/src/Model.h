...
public:
	...
	void init(const char *path)
	{
		...
		loader.load(path);
        //loader.load("resources/PointedPlane.obj");
        //loader.load("resources/Figure.obj");
...
//            }
//            
//            elements.push_back(loader.faceList[i]->vertex_index[0]+x);
//            elements.push_back(loader.faceList[i]->vertex_index[1]+x);
//            elements.push_back(loader.faceList[i]->vertex_index[2]+x);
//            //printf("f%zu: %i %i %i\n", i, elements[i*3+0], elements[i*3+1], elements[i*3+2]);
//        }
